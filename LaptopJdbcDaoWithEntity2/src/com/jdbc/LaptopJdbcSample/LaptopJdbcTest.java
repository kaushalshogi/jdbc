...
public class LaptopJdbcTest {
	...
	public static void main(String[] args) {
		...
		List<LaptopEntity> allrecords = imp.readAllRecords();
		for (LaptopEntity laptopEntity : allrecords) {
			System.out.println("all records method");
	...
	// LaptopEntity laptopEntity=new
	// LaptopEntity(11,"Bronze","Samsung",36000,"AMD",15,110,true,false);
